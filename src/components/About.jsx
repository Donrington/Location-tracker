import aboutImage from "../assets/img/p2.jpg";
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            ...
            <div className="about-content">
              <p>
                GPS Tech Solutions has been a pioneer in providing sophisticated
                GPS tracking and fleet management solutions. With a focus on
                innovation and quality, we deliver systems that offer real-time,
                actionable data to businesses and individuals alike.
              </p>
              <p>
